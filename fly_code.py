# Importing the standard libraries used
import json
import requests
...
# Library for working with QR


from pyzbar.pyzbar import decode

# Libraries for working with drones
import rospy 
from clover import srv 
from sensor_msgs.msg import Image 
from std_srvs.srv import Trigger 

# Libraries for working with video vision
import cv2 
from cv_bridge import CvBridge

# Initialize the ROS node and add the proxies necessary for the flight
...
# Creating publishers in topics for debugging
...
def navigate_wait(x=0, y=0, z=0, yaw=float("nan"), speed=0.5, frame_id='aruco_map', auto_arm=False, tolerance=0.2):
    ...
    # Flight to a point function that does not exit until the drone reaches a predetermined point
...
def take_off():
    ...
    # Function of take-off and receiving starting coordinates
...
def unregister():
    ...
    # Function for deleting all publishers and subscribers for topics
